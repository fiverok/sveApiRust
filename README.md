...
Смена пароля
В текущей версии смена пароля доступна только через прямую модификацию базы данных или создание нового пользователя.
...
Создайте новый файл в modules/ или добавьте в существующий

Импортируйте необходимые функции из других модулей

Создайте функцию инициализации маршрутов

Вызовите функцию в app.py
